...
class textGenerator(object):
    ...
    def getMessageByTags(self, tags, variables={}):
        logging.info('getMessageByTags was called')
        message =  self.torolib.buildMessage(texts = self.texts, textIndices = self.textIndices, tags=tags, variables=variables)
        if message:
